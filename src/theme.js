...
export const THUMBS = {
  ...
  "wilkins-circle-of-trust": {
    type: "image",
    src: "/cs-circle-of-trust.svg",
    alt: "Wilkins Circle of Trust — Discover, Engage, Purchase, Advocate loop",
  },
  "production-model": {
    type: "image",
    src: "/cs-production-model.svg",
    alt: "Production model redesign — sequential to parallel workstreams, 70% cost saved",
  },
  "ai-shelf-testing": {
    type: "gradient",
  ...
  "red-thread-blueprint": {
    type: "image",
    src: "/tk-rtb-thumb.png",
    alt: "Red Thread Blueprint — Master Blueprint BaZi reading cover",
  },
  "sports-edge-engine": {
    type: "image",
    src: "/tk-see-thumb.png",
    alt: "Sports Edge Engine — CLV and reliability review dashboard",
  },
};
