      ...
      <main style={{ paddingTop: "140px", paddingBottom: "120px", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ padding: "0 48px", marginBottom: "72px", opacity: loaded ? 1 : 0, transform: loaded ? "translateY(0)" : "translateY(24px)", transition: "opacity 0.8s ease 0.3s, transform 0.8s ease 0.3s" }}>
          <div style={{ maxWidth: "900px" }}>
            ...
            <h1 style={{ fontSize: "clamp(28px, 5.5vw, 76px)", fontWeight: "400", lineHeight: 1.05, letterSpacing: "-0.03em", fontFamily: "'DM Mono', monospace", margin: "0 0 32px", color: "#F0EDE8" }}>Animal Crossing<br /><span style={{ color: "#00C4B4" }}>x Deliveroo</span>.</h1>
            <p style={{ fontSize: "clamp(15px, 1.6vw, 20px)", color: "rgba(240,237,232,0.5)", lineHeight: 1.7, maxWidth: "580px", fontFamily: "'DM Mono', monospace" }}>A zero-budget brand activation built on a video game trend that earned $1.2M in media value — and a Spikes Asia Bronze — without spending a cent on paid media.</p>
          </div>
        </div>
        ...
        <div style={{ padding: "0 48px", marginBottom: "100px", opacity: loaded ? 1 : 0, transition: "opacity 0.8s ease 0.75s" }}>
          <div style={{ maxWidth: "980px" }}>
            ...
            <blockquote style={{ fontSize: "clamp(16px, 2vw, 24px)", fontWeight: "400", lineHeight: 1.55, letterSpacing: "-0.015em", color: "rgba(240,237,232,0.6)", fontFamily: "'DM Mono', monospace", margin: 0, maxWidth: "720px", borderLeft: "2px solid #00C4B4", paddingLeft: "32px" }}>
