...
const CASE_STUDIES = [
  ...
  },
  {
    ...
    year: "2023",
    award: null,
    description: "Pack, digital, and experiential stitched into one Gen Z platform across the region.",
  ...
  },
  {
    ...
    heroStatSub: "85% negative sentiment · mandate renegotiated",
    year: "2024",
    award: null,
    description: "Social listening evidence turned a global shutdown order into a tiered response.",
    slug: "kwave-crisis",
  },
  {
    id: 8,
    ...
    heroStatSub: "ANZ summer platform · frozen range",
    year: "2022",
    award: null,
    description: "One platform idea for a point-of-sale format — given brand-level storytelling.",
    slug: "coke-frozen",
  },
  {
    id: 9,
    ...
    heroStatSub: "Food babies · platform-native creative",
    year: "2020",
    award: null,
    description: "A hard commercial brief sold with a gag instead of a discount banner.",
  ...
  },
  {
    ...
    year: "2017",
    award: null,
    description: "A rapping mum told her kids to buy her some shit. The risk framework held.",
  ...
  },
  {
    ...
    heroStatSub: "$0 media · live comment-to-conversion loop",
    year: "2017",
    award: null,
    description: "A fake Singlish smart speaker run in character from the comment section.",
    slug: "lazada-kpo",
  },
  {
    id: 12,
    ...
    heroStat: "1.2M views",
    heroStatSub: "600+ flash deals · one irreverent voice",
    year: "2018",
    award: null,
    description: "The anti-sentimental voice built on stunts, tested at the year's biggest sale moment.",
  ...
  },
  {
    ...
    year: "2026",
    award: null,
    description: "A machine learning model predicting a dog's potty schedule — build depth, proven.",
    slug: "pawcast",
  },
  {
    id: 14,
    ...
    heroStatSub: "60-sec satire-noir · 4-tool AI stack",
    year: "2026",
    award: null,
    description: "AI 10x'd the execution. Taste is still the job.",
